...
public class ConsolaTest {
	...
	public void guardarElItinerarioTest() {
		...
		try {
			ArchivoSalidaObtenido = new BufferedInputStream(new FileInputStream("Salida/ConsolaTest/Itinerario ObtenidoTest.csv"));
			ArchivoSalidaEsperado = new BufferedInputStream(new FileInputStream("Salida/ConsolaTest/Itinerario EsperadoTest.csv"));
